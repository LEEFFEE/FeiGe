package cn.leeffee.feige.ui.shop.tool;
...
public class CartProvider {
    ...
    public void commit() {
        ...
        PreferencesUtils.putString(mContext, CART_JSON, GsonUtil.gson.toJson(carts));
    }
    ...
    public List<ShoppingCart> getDataFromLocal() {
        ...
        if (json != null) {
            carts = GsonUtil.gson.fromJson(json, new TypeToken<List<ShoppingCart>>() {}.getType());
        }
        return carts;
    }
