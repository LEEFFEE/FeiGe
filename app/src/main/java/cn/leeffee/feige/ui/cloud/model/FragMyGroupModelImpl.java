...
public class FragMyGroupModelImpl extends FragMyGroupContract.Model {
    ...
    public Observable<BaseResponse<List<ApiGroup>>> listGroups(String token) {
        ...
        return ApiClient.getDefault(HostType.HOST_USPACE).findshareGroupByUser(jsonParams).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<BaseResponse<List<ApiFile>>> listGroupFile(String currentRemotePath, String groupId, String token) {
        ...
        return ApiClient.getDefault(HostType.HOST_USPACE).listGroupFile(jsonParams).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<BaseResponse<Object>> makeGroupDir(String remoteDir, String groupId, String token) {
        ...
        //                "name": "cccc1232242423"
        //        }
        return ApiClient.getDefault(HostType.HOST_USPACE).makeGroupDir(jsonParams).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<BaseResponse<String>> removeGroupFile(USpaceFile[] files, String groupId, String token) {
        ...
        return ApiClient.getDefault(HostType.HOST_USPACE).removeGroupFile(jsonParams).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<BaseResponse<String>> copy2PrivateSpace(USpaceFile[] copyFiles, String copyToPath, String groupId, String token) {
        ...
        return ApiClient.getDefault(HostType.HOST_USPACE).copy2PrivateSpace(jsonParams).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
}