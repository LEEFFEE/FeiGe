...
public class USpaceEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public USpaceEditText(Context context) {
        this(context, null);
    }

    public USpaceEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public USpaceEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mClearDrawable = getResources().getDrawable(R.mipmap.search_clear_normal, null);
            } else {
