package cn.leeffee.feige.manager.cache;
...
import cn.leeffee.feige.utils.IOUtil;
...
public class DiskLruCacheHelper {
    ...
    private DiskLruCache generateCache(Context context, File dir, int maxCount) throws IOException {
        ...
        int appVersion = context == null ? DEFAULT_APP_VERSION : App.getAppVersion();
    ...
    public String getAsString(String key) {
        ...
        String str = null;
        try {
            str = IOUtil.readFully(new InputStreamReader(inputStream, Util.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
            try {
                inputStream.close();
    ...
    public void put(String key, Bitmap bitmap) {
        put(key, CommonUtil.bitmap2Bytes(bitmap));
    }
    ...
    public Bitmap getAsBitmap(String key) {
        ...
        if (bytes == null)
            return null;
        return CommonUtil.bytes2Bitmap(bytes);
    }
    ...
    public void put(String key, Drawable value) {
        put(key, CommonUtil.drawable2Bitmap(value));
    }
    ...
    public Drawable getAsDrawable(String key) {
        ...
        return CommonUtil.bitmap2Drawable(CommonUtil.bytes2Bitmap(bytes));
    }
    ...
    public boolean remove(String key) {
        try {
            key = CommonUtil.hashKeyForDisk(key);
    ...
    public InputStream get(String key) {
        try {
            DiskLruCache.Snapshot snapshot = mDiskLruCache.get(CommonUtil.hashKeyForDisk(key));
